...
The only one we will use OISST for is sea surface temperature.
...
# Historical Run
plot(cmip_anoms_bcorrect[[1]][[1]], col = temp_pal)
```
...
# # Testing Percentiles
# test_stack <- historic_bias_corr$stGrid_Surface_so_CanESM5_r10i1p1f1_historical
# test_quant <- calc(test_stack, function(rasters){
...
# assess what the issue is with invalid subsets
...
# File Names
writeRaster(full_5th, paste0(var_path, "_OISST_bias_corrected_5thpercentile.grd"))
writeRaster(full_mean, paste0(var_path, "_OISST_bias_corrected_mean.grd"))
writeRaster(full_95th, paste0(var_path, "_OISST_bias_corrected_95thpercentile.grd"))
```
